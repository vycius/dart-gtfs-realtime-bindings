...
class TripUpdate_StopTimeUpdate_ScheduleRelationship extends $pb.ProtobufEnum {
  ...
  static const TripUpdate_StopTimeUpdate_ScheduleRelationship UNSCHEDULED = TripUpdate_StopTimeUpdate_ScheduleRelationship._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNSCHEDULED');
...
class VehiclePosition_OccupancyStatus extends $pb.ProtobufEnum {
  ...
  static const VehiclePosition_OccupancyStatus NO_DATA_AVAILABLE = VehiclePosition_OccupancyStatus._(7, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'NO_DATA_AVAILABLE');
  static const VehiclePosition_OccupancyStatus NOT_BOARDABLE = VehiclePosition_OccupancyStatus._(8, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'NOT_BOARDABLE');
...
class Alert_Effect extends $pb.ProtobufEnum {
  ...
  static const Alert_Effect NO_EFFECT = Alert_Effect._(10, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'NO_EFFECT');
  static const Alert_Effect ACCESSIBILITY_ISSUE = Alert_Effect._(11, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ACCESSIBILITY_ISSUE');
...
class Alert_SeverityLevel extends $pb.ProtobufEnum {
  static const Alert_SeverityLevel UNKNOWN_SEVERITY = Alert_SeverityLevel._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNKNOWN_SEVERITY');
  static const Alert_SeverityLevel INFO = Alert_SeverityLevel._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'INFO');
  static const Alert_SeverityLevel WARNING = Alert_SeverityLevel._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'WARNING');
  static const Alert_SeverityLevel SEVERE = Alert_SeverityLevel._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SEVERE');
...
class TripDescriptor_ScheduleRelationship extends $pb.ProtobufEnum {
  ...
  static const TripDescriptor_ScheduleRelationship REPLACEMENT = TripDescriptor_ScheduleRelationship._(5, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'REPLACEMENT');
  static const TripDescriptor_ScheduleRelationship DUPLICATED = TripDescriptor_ScheduleRelationship._(6, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DUPLICATED');
...
class VehicleDescriptor_WheelchairAccessible extends $pb.ProtobufEnum {
  static const VehicleDescriptor_WheelchairAccessible NO_VALUE = VehicleDescriptor_WheelchairAccessible._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'NO_VALUE');
  static const VehicleDescriptor_WheelchairAccessible UNKNOWN = VehicleDescriptor_WheelchairAccessible._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNKNOWN');
  static const VehicleDescriptor_WheelchairAccessible WHEELCHAIR_ACCESSIBLE = VehicleDescriptor_WheelchairAccessible._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'WHEELCHAIR_ACCESSIBLE');
  static const VehicleDescriptor_WheelchairAccessible WHEELCHAIR_INACCESSIBLE = VehicleDescriptor_WheelchairAccessible._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'WHEELCHAIR_INACCESSIBLE');
